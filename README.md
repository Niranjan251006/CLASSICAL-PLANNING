...
# Check whether the current state satisfies a condition
...
# Apply the effects of an action
def apply_action(state, effect):
    new_state = state.copy()
    new_state.update(effect)
    return new_state

# Classical Planning using Breadth-First Search
...
```
# OUTPUT:
<img width="532" height="125" alt="image" src="https://github.com/user-attachments/assets/1d6bbe81-cfed-4001-84b9-337191099026" />
